            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Brand Module</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.units.create') }}" class="slide-item">Add Unit</a></li>
                        <li><a href="{{ route('admin.units.index') }}" class="slide-item">Manage Unit</a></li>
                    </ul>
                </li>
                {{--Product Module--}}
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.products.create') }}" class="slide-item"> Add Product</a></li>
                        <li><a href="{{ route('admin.products.index') }}" class="slide-item"> Manage Product</a></li>
                    </ul>
                </li>
                {{--Order Module--}}
                <li class="slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Customer Module</a></li>
                        <li><a href="#" class="slide-item">Add Customer</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="calendar2.html" class="slide-item">Add User</a></li>
                        <li><a href="chat.html" class="slide-item">Manage User</a></li>
                    </ul>
                </li>
                {{--Coupon Module--}}
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Coupon Module</a></li>
                        <li><a href="alerts.html" class="slide-item">Add Coupon</a></li>
                        <li><a href="avatar.html" class="slide-item">Manage Coupon</a></li>
                    </ul>
                </li>
                {{--Setting Module--}}
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="accordion.html" class="slide-item">Company Setting</a></li>
                        <li><a href="carousel.html" class="slide-item">Tax Setting</a></li>
                        <li><a href="cards.html" class="slide-item">Shipping Setting</a></li>
                    </ul>
                </li>
            </ul>
